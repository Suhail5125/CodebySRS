...
export function ServicesSection() {
  ...
  return (
    <section
      id="services"
      className="snap-screen relative flex min-h-screen flex-col justify-center px-4 py-16 sm:px-6 lg:px-10"
    ...
    >
      <div className="mx-auto w-full max-w-[1400px]">
        ...
        {/* Slab stack — overflow hidden so skewed edges never poke out */}
        <div
          className="relative"
