...
export const MOCK_PROJECTS: Project[] = [
  {
    ...
    description: "Real-time 3D product configurator for an industrial OEM. Three.js + React + Vercel Edge.",
    imageUrl: null,
  ...
  },
  {
    id: "p-002",
    title: "Numen CMS",
    description: "Headless CMS for a media network. PostgreSQL, Drizzle ORM, fine-grained RBAC.",
    imageUrl: null,
  ...
  },
  {
    ...
    description: "Realtime energy telemetry dashboard. WebSockets, sub-second charting, dark-only UI.",
    imageUrl: null,
  ...
  },
  {
    id: "p-004",
    title: "Klein Bottles",
    description: "E-commerce for a craft brewery. Headless Shopify, custom checkout, +38% conversion.",
    imageUrl: null,
  ...
  },
  {
    id: "p-005",
    title: "Fieldnote",
    description: "Offline-first PWA for field researchers. Sync engine, conflict resolution, IndexedDB.",
    imageUrl: null,
  ...
  },
  {
    ...
    description: "Marketing site for a motion design studio. WebGL hero, 100/100 Lighthouse.",
    imageUrl: null,
...
export const MOCK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    role: "VP Product",
    company: "Helix Labs",
    content: "The team rebuilt our checkout in three weeks. Conversion went up 22% and the codebase is finally something we enjoy working in.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 1,
  ...
  },
  {
    ...
    role: "CTO",
    company: "Voltline",
    content: "Brutally clear communicator. Shipped a real-time dashboard our ops team uses every single shift. No drama, just delivery.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 2,
  ...
  },
  {
    ...
    role: "Founder",
    company: "Fieldnote",
    content: "Hired the studio to consult, ended up shipping the whole MVP with them. Type-safe end-to-end and faster than any team I've worked with.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 3,
  ...
  },
  {
    ...
    content: "Pixel-perfect handoffs with WebGL flair. He cares about motion the same way good designers care about typography.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 4,
  ...
  },
  {
    ...
    company: "Numen Media",
    content: "Architected our headless CMS with patience and rigor. PRs came with diagrams. Onboarding new engineers is now a non-event.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 5,
  ...
  },
  {
    ...
    content: "We asked for a marketing site and got a revenue engine. The brutalist art direction is now the centrepiece of the brand.",
    rating: 5,
    avatarUrl: null,
    isVisible: true,
    order: 6,
